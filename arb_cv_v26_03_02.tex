...
\begin{itemize}[leftmargin=*, nosep]
\item Co-built a black-box evaluation framework for measuring eval-awareness in frontier LLMs, benchmarking multiple measurement methods across frontier models.
\item Ideated and ran experiments to perform rigorous analysis on self-attribution bias and prompted eval-awareness using  deployment transcripts and domain-matched evaluation transcripts.
\end{itemize}
