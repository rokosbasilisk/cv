...
\begin{itemize}[leftmargin=*, nosep]
\item Co-designed and implemented the core architecture for a dynamic benchmark measuring evaluation awareness in large language models.
\item Designed and ran experiments to elicit and characterize eval-awareness behavior across different evaluation and prompting settings.
\end{itemize}
