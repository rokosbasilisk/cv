...
\SkillsEntry{Deep learning Frameworks}{PyTorch (Expert level profeciency), JAX}
\SkillsEntry{DevOps}{Kubernetes, Docker-swarm}
\SkillsEntry{Frameworks}{Akka, Spring-boot}
\SkillsEntry{AI/ML}{LLM Fine-tuning, Neural Network Architecture Implementation, Random Forests, XGBoost (almost all decision tree based models), Model Ensembling techniques}
