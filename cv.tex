...
AI safety researcher and engineer with 6+ years developing production AI systems and leading engineering teams. Independent researcher with preprints on activation steering, model interpretability, and LLM inference optimization. Currently researching evaluation awareness in large language models.
...
\item Developed \href{https://github.com/arambharadwaj/STU-PID}{PID-Steering}, a novel activation steering technique for reducing computational overhead in LLMs. Published as \href{https://arxiv.org/abs/2506.18831}{Steering Token Usage with PID Control}.
\end{itemize}
